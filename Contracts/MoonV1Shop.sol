...
import "./Interfaces/IMoonV1Shop.sol";
...
contract MoonV1Shop is IMoonV1Shop, NoDelegateCall {
    ...
    function snapshotCumulativesInside(int24 _unitLower, int24 _unitUpper)
        external
        view
        override
        noDelegateCall
    ...
    function _modifyproof(ModifyProofParams memory params)
        private
        noDelegateCall
        returns (
